        ...
        <ul class="topmenu topmenu-responsive" data-toggle="menu">
            ...
            <li class="permohonan-ijin">
                ...
                <ul id="ijin" class="submenu collapse">
                    ...
                    <li class="lihat-data">
                        <a href="<?php echo base_url('admin/permohonan-ijin/lihat-data') ?>">
            ...
            <li class="pengguna">
                <a href="javascript:void(0);" data-target="#pengguna" data-toggle="submenu" data-parent=".topmenu">
                    <span class="figure"><i class="ico-user"></i></span>
                    <span class="text">Pengguna</span>
                    <span class="arrow"></span>
                </a>
                <ul id="pengguna" class="submenu collapse">
                    <li class="submenu-header ellipsis">Pengguna</li>
                    <li class="lihat">
                        <a href="<?php echo base_url('admin/pengguna/lihat') ?>">
                            <span class="text">Lihat Semua</span>
                        </a>
                    </li>
                    <li class="tambah">
                        <a href="<?php echo base_url('admin/pengguna/tambah') ?>">
