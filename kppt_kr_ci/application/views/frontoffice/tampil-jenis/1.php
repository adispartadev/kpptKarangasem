...
<table class="table">
    ...
    <tr>
        ...
        <td>
			<a target="_BLANK" href="<?php echo base_url('resources/file-ipr/'.$kelengkapan['bukti_kepemilikan']) ?>">Lihat File</a>
        </td>
    </tr>
    <tr>
        <td>Alamat</td>
	...
	<tr>
	    <td>Jenis IPR</td>
	    <td><?php echo tampil_data_exc($kelengkapan['jenis_ipr']); ?></td>
	</tr>
