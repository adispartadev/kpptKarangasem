...
?>
        ...
        <section class="panel panel-white">
            <header class="panel-heading">
                <h3 class="panel-title">Identitas Pusat Perbelanjaan</h3>
            </header>
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label">Nama Pusat Perbelanjaan <span class="text-danger">*</span></label>
                    <div class="col-sm-5">
                        <input type="text" name="nama_pusat_perbelanjaan" class="form-control" required="">
                    </div>
                </div>
                <div class="form-group">
