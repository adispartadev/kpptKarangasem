...
<div class="form-group">
    <label class="col-sm-2 control-label">Jenis IPR <span class="text-danger">*</span></label>
    <div class="col-sm-5">
        <select class="form-control" name="jenis_ipr">
            <?php foreach($ipr_jenis as $ipr_jen){ ?>
                <option value="<?php echo $ipr_jen['id_ipr_jenis'] ?>"><?php echo $ipr_jen['nama_jenis'] ?></option>
            <?php } ?>
        </select>
    </div>
</div>