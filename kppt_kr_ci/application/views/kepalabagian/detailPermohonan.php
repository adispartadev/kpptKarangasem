    ...
    <!-- START modal -->
        <div id="bs-modal" class="modal fade">
            <div class="modal-dialog">
                ...
                <?php echo form_open_multipart('kepalabagian/permohonan-ijin/validasi/'.$permohonan_ijin['token'].'/submit', 'class = "form-horizontal"') ?>

                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Disposisi Kepada</label>
                            <div class="col-sm-9">
                                <input type="text" name="" disabled="" class="form-control" value="Kasi">
                            </div>
                        </div>  
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Catatan</label>
                            <div class="col-sm-9">
                                <textarea name="catatan_to_kasi" rows="5" class="form-control">
        ...
        <!-- START modal -->
            <div id="bs-modal-tolak" class="modal fade">
                <div class="modal-dialog">
                    ...
                    <?php echo form_open_multipart('kepalabagian/permohonan-ijin/tolak/'.$permohonan_ijin['token'].'/submit', 'class = "form-horizontal"') ?>
